const CONSTELLATION_TRANSLATIONS = {
  ...
  Centaurus: { en: "Centaurus", ko: "켄타우루스자리" },
  Cepheus: { en: "Cepheus", ko: "케페우스자리" },
  ...
  Hercules: { en: "Hercules", ko: "헤라클레스자리" },
  ...
  en: {
    ...
    viewer: {
      ...
      ambient: {
        ...
        preparingHint: "Rendering the original night-sky soundscape for playback.",
      ...
      constellationFocus: "Constellation spotlight",
      atmosphere: "Sky mood",
      ...
      updateSketch: "Update space",
      saveSketchAsNew: "Save as new",
      savedSketch: "Sketch",
      savedSketches: "Saved spaces",
      noSavedSketches: "No saved sketches yet.",
      deleteSketch: "Delete",
      previewInWatch: "View in night sky",
      renameSketch: "Rename",
      renameSketchPrompt: "Enter a new name for this saved space.",
      pinSketch: "Pin",
      unpinSketch: "Unpin",
      watchingSketchTitle: "Sketch viewing",
      watchingSketchHint: "You are appreciating a saved custom space in read-only mode.",
      returnLiveSky: "Return to live sky",
      ...
      activeConstellationHintReady: "Drag stars in the canvas to reshape this constellation, or use the arrange controls for bigger moves.",
      activeConstellationHintEmpty: "Add stars to begin this constellation, or import a ready-made one as a starting point.",
      constellationName: "Constellation name",
      constellationColor: "Constellation color",
      customConstellation: "Constellation",
      customConstellationsCount: "Constellations",
      constellationDragHint: "Drag the ring handle in the canvas to move this constellation as one group.",
  ...
  ko: {
    ...
    viewer: {
      ...
      ambient: {
        ...
        preparingHint: "원래 밤하늘 사운드스케이프를 재생용 트랙으로 렌더링하고 있습니다.",
      ...
      focusConstellation: "포커스 별자리",
      searchConstellation: "별자리 찾기",
      searchPlaceholder: "별자리 입력",
      trackConstellation: "선택한 별자리 따라가기",
      ...
      clearSketch: "우주 비우기",
      saveSketch: "우주 저장",
      updateSketch: "우주 업데이트",
      saveSketchAsNew: "새 우주로 저장",
      savedSketch: "우주",
      savedSketches: "저장한 우주",
      noSavedSketches: "아직 저장한 우주가 없습니다.",
      deleteSketch: "삭제",
      previewInWatch: "밤하늘에서 감상",
      renameSketch: "이름 변경",
      renameSketchPrompt: "저장한 우주의 새 이름을 입력해 주세요.",
      pinSketch: "고정",
      unpinSketch: "고정 해제",
      watchingSketchTitle: "스케치 감상",
      watchingSketchHint: "저장한 우주를 읽기 전용 감상 모드로 보고 있습니다.",
      returnLiveSky: "실시간 하늘로 돌아가기",
      ...
      activeConstellationHintReady: "캔버스에서 별을 직접 끌어 별자리를 다듬거나, 배치 조정 버튼으로 크게 움직여 보세요.",
      activeConstellationHintEmpty: "이 별자리에 별을 추가하거나, 완성된 별자리를 불러와 시작점으로 삼아 보세요.",
      constellationName: "별자리 이름",
      constellationColor: "별자리 색상",
      customConstellation: "별자리",
      customConstellationsCount: "별자리 수",
      constellationDragHint: "캔버스 안의 링 핸들을 끌어 이 별자리를 한 묶음으로 이동할 수 있습니다.",
